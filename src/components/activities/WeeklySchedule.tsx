        ...
        <div className="w-full overflow-x-auto">
            <div className="min-w-[800px]">
                ...
                <div className="grid grid-cols-8 gap-1 mb-2">
                    ...
                    {DAYS.map(day => (
                        <div key={day} className="text-center font-medium text-sm text-white bg-gray-800 py-2 rounded-t">
                            {day.slice(0, 3)}
                        </div>
                    ))}
                </div>
                ...
                <div className="grid grid-cols-8 gap-1">
                    ...
                    <div className="flex flex-col">
                        {TIME_SLOTS.map(time => (
                            <div key={time} className="h-12 text-sm text-white bg-gray-800 flex items-center px-2">
                                {time}
                            </div>
                        ))}
                    </div>
                            ...
                            {TIME_SLOTS.map(time => {
                                ...
                                return (
                                    <div
                                        ...
                                        className={`h-12 border border-gray-600 rounded ${
                                            isOccupied
                                        ...
                                        style={{
                                            ...
                                            color: isOccupied ? "#000000" : "#FFFFFF"
                                        }}
                                        role="button"
