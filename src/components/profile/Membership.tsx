                ...
                <div className="space-y-6">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <p className="text-white font-medium">{user.memberSince}</p>
                        </div>
                        <div className="space-y-2">
                            <p className="text-gray-400">Next payment</p>
                            <p className="text-white font-medium">{user.nextPayment}</p>
                        </div>
                    </div>
                    
                    <div>
                        <h4 className="text-white font-medium mb-3">Benefits included:</h4>
                        <div className="space-y-2">
                            {benefits.map((benefit, index) => (
                                <div key={index} className="flex items-center gap-2">
                                    <svg 
                                        className={`w-5 h-5 ${benefit.included ? 'text-green-500' : 'text-gray-500'}`} 
                                        fill="none" 
                                        stroke="currentColor" 
                                        viewBox="0 0 24 24"
                                    >
