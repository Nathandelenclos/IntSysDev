            ...
            <section className="flex flex-col h-full bg-[linear-gradient(180deg,_#03080B_0%,_#012E4A_100%)] bg-cover overflow-hidden p-16 gap-8">
                <div className="flex flex-col w-[1000px] mx-auto gap-8">
                    <div className="flex justify-between px-8">
                        <h2 className="text-4xl font-bold uppercase text-white">How to train at home</h2>
                        <Link href="#" className="bg-[#FFD600] rounded-md px-4 py-2 font-bold">Like</Link>
                    </div>
                    <div className="flex flex-col bg-white p-8 rounded-xl gap-4">
                        <div>
                    ...
                    <div className="flex justify-between px-8">
                        <h2 className="text-4xl font-bold uppercase text-white">Comments</h2>
                        <Link href="#" className="bg-[#FFD600] rounded-md px-4 py-2 font-bold">Leave a comment</Link>
                    </div>
                    <div className="flex flex-row gap-8 px-8 py-4 bg-white rounded-xl justify-center items-center">
